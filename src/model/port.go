...
type Port struct {
	...
	DockingSpots *json.RawMessage `gorm:"column:docking_spots;type:jsonb" json:"docking_spots,omitempty"`
	Services     *json.RawMessage `gorm:"column:services;type:jsonb" json:"services,omitempty"`
